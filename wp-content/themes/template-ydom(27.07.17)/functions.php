...
function get_result($ajax=false){
	...
	$settings_period = get_field('settings_period', 33);
	...
	$url = "http://api.rent-scaner.ru/v2/real-estate?_format=xml&expand=longitude,latitude,isRealtor&".$token.
		$cityId.
