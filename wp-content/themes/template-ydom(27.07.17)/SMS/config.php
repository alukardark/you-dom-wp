<?php
	define("HTTPS_LOGIN", "pototsky"); //Ваш логин для HTTPS-протокола
	define("HTTPS_PASSWORD", "CBRnwgp6"); //Ваш пароль для HTTPS-протокола
	define("HTTPS_ADDRESS", "http://lcab.sms-usluga.ru/"); //HTTPS-Адрес, к которому будут обращаться скрипты. Со слэшем на конце.
	define("HTTP_ADDRESS", "http://lcab.sms-usluga.ru/"); //HTTP-Адрес, к которому будут обращаться скрипты. Со слэшем на конце.
