    ...
    <div class="main main-inner">
                            ...
                            <div class="withPhoto-wrap">
                                ...
                                <div style="display: none">
                                    <?php if (get_field('settings_with-realtors', 33) == 1): ?>
                                        ...
                                        <input checked id="withRealtors" type="checkbox" class="withRealtors" name="filter[withRealtors]"  value="1">
        ...
        <div class="catalog">
            <div class="wrapper">
                ...
                <h2 id="rev-desc">Не нужно ехать в офис — оплата и заключение договора с арендодателем по факту заселения!</h2>
